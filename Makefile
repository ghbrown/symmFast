...
PROJ_LINKER_FLAGS = -shared -dynamiclib -Wl,-bind_at_load -Wl,-multiply_defined,suppress -Wl,-commons,use_dylibs -Wl,-search_paths_first -Wl,-no_compact_unwind	-fsanitize=address
